# Copy this to /home/lab/amosy/anaconda3/envs/sam/lib/python3.6/site-packages/shap/explainers/deep
import numpy as np
import warnings
            ...
            for j in range(X[0].shape[0]):
                ...
                if self.interim:
                    ...
                    for l in range(len(X)):
                        tmp1 = torch.from_numpy(sample_phis[l][self.data[l].shape[0]:])
                        tmp2 =  (X[l][j: j + 1] - self.data[l])
                        tmp1 = tmp1.to('cuda')#MY CHANGE!!! 
                        phis[l][j] = (tmp1 * tmp2).cpu().mean(0)
